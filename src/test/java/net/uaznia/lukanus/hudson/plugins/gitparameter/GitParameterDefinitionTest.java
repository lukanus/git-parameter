...
//        System.out.println("generateContents");
  //      String contenttype = "";
    ...
    public void testGetProjectSCM() throws Exception {
        super.setUp();
        FreeStyleProject testJob = jenkins.createProject(FreeStyleProject.class, "testJob");
        GitSCM git = new GitSCM("https://github.com/jenkinsci/git-parameter-plugin.git");
